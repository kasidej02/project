...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(324, 226);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(324, 255);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(324, 284);
			...
			this->button4->Location = System::Drawing::Point(324, 313);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(285, 12);
